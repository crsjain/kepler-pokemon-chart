...
- 🪙 **Star Vault & Partner Shop**:
  ...
  - **Star Counts & Rarity Trophies**: The Star Vault features a dedicated **Star Counts** shelf displaying all-time earned stars across all 4 streak rarity tiers (🌟 `Day 1-2 Yellow`, 🥈 `Day 3-4 Silver`, 📘 `Day 5-9 Blue`, 🌈 `Day 10+ Prism`) in clean 2-row micro-cards (`[Star] ×N` + `Day X-Y`), celebrating milestone achievements with permanent collectible counts and zero loss-aversion risk.
