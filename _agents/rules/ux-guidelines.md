...
- **Visual Hierarchy & Cohesion Invariant (Pokémon Gym Badge Vector Assets)**: 
  ...
  - **Earned Star Badge (27px × 27px, `.badge-indicator.unlocked`)**: Rendered with Pikachu Yellow fill (`#ffcb05`), a 2.6px charcoal border (`#2d3748`), faceted warm amber 3D shading (`#d97706`, 32% opacity), a specular cartoon glint at the apex, and crisp 2px retro elevation (`drop-shadow(0 2px 0 rgba(180, 83, 9, 0.35))`). On completion/render, a 0.35s `.badge-pop` spring bounce celebrates the achievement. Unlocked cells use a subtle warm tile background (`rgba(254, 243, 199, 0.45)`, `border-radius: 6px`) eliminating fuzzy Gaussian blur smudges.
